...
def insertar_libro(titulo, descripcion, precio,imagen):
    try:
        ...
        with conexion.cursor() as cursor:
            cursor.execute("INSERT INTO libros(titulo, descripcion, precio,imagen) VALUES (%s, %s, %s,%s)",
...
def obtener_libro_por_id(id):
    ...
    try:
        ...
        with conexion.cursor() as cursor:
            ...
            cursor.execute("SELECT id, titulo, descripcion, precio,imagen FROM libros WHERE id =" + id)
